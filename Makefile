...
S3_BUCKET=des-massues-dans-le-vent
...
s3_upload: publish
	s3cmd --exclude="photos/*" --exclude="images/*" sync $(OUTPUTDIR)/ s3://$(S3_BUCKET) --acl-public --delete-removed --guess-mime-type --no-mime-magic --no-preserve
